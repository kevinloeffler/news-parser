...
3)  Save the list as a serialized pickle file in the parsed-pages directory with save_crawled_pages()

Parser
1)  Define the target words
2)  Create a text parser for the specific newspaper
3)  Load the serialized pages from the parsed-pages directory
4)  Parse every page
